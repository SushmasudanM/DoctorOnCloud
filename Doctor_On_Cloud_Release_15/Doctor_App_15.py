"""
we are adding logout option to login place
"""
...
Doctor_App_15 = flask.Flask("Doctor_App_15")
# --------------------

Doctor_App_15.secret_key = "My secret password"
Doctor_App_15.config["SESSION_TYPE"] = "filesystem"

Session(Doctor_App_15)
...
# --------------------
@Doctor_App_15.route('/validate', methods=['POST'])
...
# --------------------
@Doctor_App_15.route('/register', methods=['POST'])
...
# --------------
@Doctor_App_15.route('/newpatient')
...
@Doctor_App_15.route('/newpatient', methods=['POST'])
def my_patient_page():
    ...
    my_query = f"INSERT INTO PATIENT_TABLE ( PATIENTNAME, PATIENTCONTACT, BLOODPRESSURE , SUGAR, FEVER, COLD, REMARKS ) VALUES ('{entered_patient_name}', '{entered_patient_contact}', '{entered_bp}', '{entered_sugar}', '{entered_fever}', '{entered_cold}','{entered_remarks}' )"
    my_db_cursor.execute(my_query)
    my_db_connection.commit()
    my_db_connection.close()
    return "<center><h2>Patient Details Created Successfully.<br> <a href='/patientdetails'>patientdetails</a></h2></center>"

# --------------------
# END POINT - 9 : http://127.0.0.1:5000/patientdetails URL MAPPED to '/patientdetails'
# ---------------------
@Doctor_App_15.route('/patientdetails')
def my_patientdetails_page():
    return flask.render_template('patientdetails.html')

# -----------------
@Doctor_App_15.route('/patientdetails', methods=['GET'])
