...
# --------------------
import flask
Doctor_App_12 = flask.Flask("Doctor_App_12")
# --------------------
...
# --------------------
@Doctor_App_12.route('/validate', methods=['POST'])
...
# --------------------
@Doctor_App_12.route('/register', methods=['POST'])
