"""
we are adding header footer and background images
"""
...
# --------------------
import flask
Doctor_App_11 = flask.Flask("Doctor_App_11")
# --------------------
...
# --------------------
@Doctor_App_11.route('/validate', methods=['POST'])
...
# --------------------
@Doctor_App_11.route('/register', methods=['POST'])
